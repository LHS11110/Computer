...
### 함수(Function)
함수란 어떠한 목적을 달성하기 위해 호출 및 반환될 수 있는 코드 집합을 말한다.<br/>
함수는 크게 선언부와 구현부(또는 정의부)로 나뉠 수 있으며 각각의 의미는 아래와 같다.<br/>
<br/>
- 선언부란 함수명과 반환 타입, 매개변수 목록으로 구성된 것을 말한다.<br/>
- 구현부란 해당 함수가 호출됬을 때 수행되는 코드 집합을 말한다.<br/>
<br/>
...
한 번 정의되기만 하면 함수명을 통해 여러번의 호출이 가능하기 때문에 반복되는 문제를 쉽게 해결할 수 있다.<br/>
...
유효 범위를 가지기에 함수 내에서 선언한 변수는 외부 로직에 의해 변경될 수 없다는 안정성을 가진다.
## 절차적 프로그래밍의 단점
