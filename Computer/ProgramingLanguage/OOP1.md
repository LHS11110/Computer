...
### 함수(Function)
함수란 어떠한 목적을 달성하기 위해 개발자가 호출(Call)할 수 있는 코드 집합을 말한다.<br/>
크게  선언부와 구현부를 가지며 선언부는 함수명과 반환 타입, 매개변수가 포함된 것을 말하고<br/>
구현부는 해당 함수가 호출됬을 때 수행되는 코드 집합을 말한다.<br/>
...
유효 범위를 가지기에 함수 내에서 선언한 변수는 외부 로직에 의해 변경될 수 없다는 안정성을 가진다.<br/>
